...
public class MyBox2DDebugRenderer  {
    ...
    public MyBox2DDebugRenderer () {
        this(true, true, false, true, false, true);
    }

    public MyBox2DDebugRenderer (boolean drawBodies, boolean drawJoints, boolean drawAABBs, boolean drawInactiveBodies,
    ...
    public final Color SHAPE_NOT_ACTIVE = new Color(0.5f, 0.5f, 0.3f, 0.4f).mul(0.4f);
    public final Color SHAPE_STATIC = new Color(0.5f, 0.9f, 0.5f, 0.4f).mul(0.4f);
    public final Color SHAPE_KINEMATIC = new Color(0.5f, 0.5f, 0.9f, 0.4f).mul(0.4f);
    public final Color SHAPE_NOT_AWAKE = new Color(0.6f, 0.6f, 0.6f, 0.4f).mul(0.4f);
    public final Color SHAPE_AWAKE = new Color(0.9f, 0.7f, 0.7f, 0.4f).mul(0.4f);
    public final Color JOINT_COLOR = new Color(0.5f, 0.8f, 0.8f, 0.4f).mul(0.4f);
    public final Color AABB_COLOR = new Color(1.0f, 0, 1.0f, 0.4f).mul(0.4f);
    public final Color VELOCITY_COLOR = new Color(1.0f, 0, 0f, 0.4f).mul(0.4f);
    ...
    public static void setAxis (Vector2 axis) {
        MyBox2DDebugRenderer.axis = axis;
    }
